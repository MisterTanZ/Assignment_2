...
if __name__ == "__main__":
    ...
    savings_acc = SavingsAccount("TAKSIN", name="TAKSIN", account_type="savings", balance=1000)
    ...
    fixed_acc = FixedDeposit("N'TAN", name="N'TAN", account_type="fixed deposit", balance=2000)
